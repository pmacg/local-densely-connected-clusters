...
extern "C"
{
    ...
    /**
     * A C interface for the double cover weighted pagerank.
     ...
     * @param a - the data array for the compressed sparse row adjacency matrix
    ...
    /**
     * A C interface for weighted double cover pagerank.
     * @param n - the number of vertices in the graph
     * @param ai - the indptr array for the compressed sparse row adjacency matrix
     * @param aj - the index array for the compressed sparse row adjacency matrix
     * @param a - the data array for the compressed sparse row adjacency matrix
    ...
    /**
     * A C interface for weighed double cover pagerank.
     * @param n - the number of vertices in the graph
     * @param ai - the indptr array for the compressed sparse row adjacency matrix
     * @param aj - the index array for the compressed sparse row adjacency matrix
     * @param a - the data array for the compressed sparse row adjacency matrix
